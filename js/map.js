...
var azsIcon = new LeafIcon({iconUrl: 'src/map-icons/azs.svg'}),
    bankIcon= new LeafIcon({iconUrl: 'src/map-icons/bank.svg'}),
    bankIcon2 = new LeafIcon({iconUrl: 'src/map-icons/bank2.svg'}),
    cafeIcon = new LeafIcon({iconUrl: 'src/map-icons/cafe.svg'}),
    daycareIcon = new LeafIcon({iconUrl: 'src/map-icons/daycare.svg'}),
    hospitalIcon= new LeafIcon({iconUrl: 'src/map-icons/hospital.svg'}),
    hospitalIcon2 = new LeafIcon({iconUrl: 'src/map-icons/hospital2.svg'}),
    locationIcon = new LeafIcon({iconUrl: 'src/map-icons/location.svg'}),
    pullIcon = new LeafIcon({iconUrl: 'src/map-icons/pull.svg'}),
    shopIcon = new LeafIcon({iconUrl: 'src/map-icons/shop.svg'}),
    shopIcon2 = new LeafIcon({iconUrl: 'src/map-icons/shop2.svg'});
